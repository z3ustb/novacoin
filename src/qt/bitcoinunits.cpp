...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZUC");
    case mBTC: return QString("mZUC");
    case uBTC: return QString::fromUtf8("μZUC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("ZUC"));
    case mBTC: return QString(QObject::tr("Milli-ZUC (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-ZUC (1 / 1,000,000)"));
    default: return QString("???");
    }
}
