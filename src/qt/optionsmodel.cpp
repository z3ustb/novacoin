...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/zuc/tx/%s|https://coinplorer.com/ZUC/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/ZUC/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/zuc/tx/%s|https://coinplorer.com/ZUC/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/ZUC/tx/%s").toString();
